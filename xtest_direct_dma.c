...
void XTest_direct_dma_Continue(XTest_direct_dma *InstancePtr) {
    u32 Data;
    ...
    Data = XTest_direct_dma_ReadReg(InstancePtr->Axilites_BaseAddress, XTEST_DIRECT_DMA_AXILITES_ADDR_AP_CTRL) & 0x80;
    XTest_direct_dma_WriteReg(InstancePtr->Axilites_BaseAddress, XTEST_DIRECT_DMA_AXILITES_ADDR_AP_CTRL, Data | 0x10);
}
